...
<div class="container">
    <div class="text-center mb-4">
        <img src="{{ asset('logo.jpg') }}" alt="Logo {{ config('app.name', 'Armani') }}" class="img-fluid" style="max-height: 100px;">
    </div>
    ...
    <h2 class="text-center mb-4">DONNEES INFRASTRUCTURES SOCIOCOMMUNAUTAIRES ET ÉCONOMIQUES/{{ config('app.name', 'Armani') }}</h2>
