...
class InfrastructureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'etat_fonctionnement' => ['nullable', 'string', 'in:Fonctionnel,Partiellement fonctionnel,Non fonctionnel,En construction'],
            'niveau_degradation' => ['nullable', 'string', 'in:Faible,Moyen,Élevé,Aucun'],
